        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header d-flex justify-content-between align-items-center border-0">
              ...
              <a href="add_staff.php" class="btn btn-custom-add">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="hrm.php?delete=<?php echo $staff->staff_id; ?>" class="btn btn-sm btn-danger btn-custom-delete me-2">
                          <i class="fas fa-trash"></i> Delete
                        </a>
                        <a href="update_staff.php?update=<?php echo $staff->staff_id; ?>" class="btn btn-sm btn-primary btn-custom-update">
